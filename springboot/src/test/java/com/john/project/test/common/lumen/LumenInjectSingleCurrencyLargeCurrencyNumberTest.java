...
public class LumenInjectSingleCurrencyLargeCurrencyNumberTest extends BaseTest {
    ...
    public void test() {
        ...
        var obtainCcuOfSeven = this.lumenContext.inject(lumenContext.getUsd(), new BigDecimal("640000"));
        ...
        assertTrue(ObjectUtil.equals(new BigDecimal("23740.302804"), result));
        assertTrue(ObjectUtil.equals(new BigDecimal("99580542240498632888085.862250"), obtainJapanCurrencyBalance));
        assertTrue(ObjectUtil.equals(new BigDecimal("196.078431"), obtainCcuOfFirst));
        assertTrue(ObjectUtil.equals(new BigDecimal("5984.024247"), obtainCcuOfSix));
    }

    @BeforeEach
    public void beforeEach() {
        this.lumenContext = new LumenContextCoreModel();
        this.lumenContext.injectPair(new BigDecimal(100), new BigDecimal("100000000000000000000000"));
    }
